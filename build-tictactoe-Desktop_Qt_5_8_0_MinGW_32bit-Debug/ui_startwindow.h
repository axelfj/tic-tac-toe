...
"background-color: none;"));
    ...
    void retranslateUi(QMainWindow *StartWindow)
    {
        ...
        m8->setText(QString());
        m1->setText(QString());
        name_title->setText(QApplication::translate("StartWindow", "What's your name?", Q_NULLPTR));
        name_edit->setPlaceholderText(QString());
        name_btn->setText(QString());
        winner_title->setText(QApplication::translate("StartWindow", "This is the winner!", Q_NULLPTR));
        winner_icon->setText(QString());
        winner_bg->setText(QString());
        winner_btn->setText(QApplication::translate("StartWindow", "CLOSE", Q_NULLPTR));
    } // retranslateUi
